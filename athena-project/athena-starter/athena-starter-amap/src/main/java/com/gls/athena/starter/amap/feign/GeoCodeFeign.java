...
import com.gls.athena.starter.amap.config.AmapConfig;
 ...
 * @author george
 */
@FeignClient(name = "amap", contextId = "geocode", path = "/geocode", url = IAmapConstants.URL, configuration = AmapConfig.class)
